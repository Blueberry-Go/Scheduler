...
```bash
go get github.com/blueberry-go/scheduler
```

### Getting Started

Below is an example script to demonstrate how to use BlueBerry. You can find the full example in the [example/filesystem/main.go](https://github.com/blueberry-go/scheduler/blob/production/example/filesystem/main.go) file.
...
For a complete example of how to set up and use BlueBerry, see the [full example](https://github.com/blueberry-go/scheduler/blob/production/example/filesystem/main.go) in the repository.
